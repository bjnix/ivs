...
void display()
{
  //  usleep(10000);
	...
	Output_GetSegmentGlobalTranslation globalTranslate1 = MyClient.GetSegmentGlobalTranslation("Wand", "Wand");
	Output_GetSegmentGlobalTranslation globalTranslate2 = MyClient.GetSegmentGlobalTranslation("Dude", "Dude");
